...
// #workaround(Swift 5.2.2, Web doesn’t have Foundation yet.)
  ...
  extension NSMutableAttributedString {
      ...
      private func swapGlyphs(
        ...
        additionalChangesWhenTriggered makeAdditionalChanges: (inout [NSAttributedString.Key: Any])
          ->
          Void
      ) {
          ...
          while scalarStart ≠ section.scalars.endIndex {
            ...
            while tryLonger ∧ scalarEnd ≠ section.unicodeScalars.endIndex {
              let character = String(
                section.unicodeScalars[scalarStart..<section.scalars.index(after: scalarEnd)]
              )
    ...
    // MARK: - Superscript & Subscript
      ...
      private func modifyCasing(of range: NSRange, caseMapping: (String) -> String) {
        ...
        swapGlyphs(
          ...
          additionalChangesWhenTriggered: { _ in }
        )
      }
