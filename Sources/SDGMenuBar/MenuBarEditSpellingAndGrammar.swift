 ...
 */
  ...
  extension MenuBar {
    ...
    private static func showSpellingAndGrammar() -> MenuEntry<MenuBarLocalization> {
      let showSpellingAndGrammar = MenuEntry(
        label: .static(
    ...
    private static func checkDocumentNow() -> MenuEntry<MenuBarLocalization> {
      let checkDocumentNow = MenuEntry(
        label: .static(
          UserFacing<StrictString, MenuBarLocalization>({ localization in
            switch localization {
            case .españolEspaña:
    ...
    private static func checkSpellingWhileTyping() -> MenuEntry<MenuBarLocalization> {
      let checkSpellingWhileTyping = MenuEntry(
        label: .static(
          UserFacing<StrictString, MenuBarLocalization>({ localization in
            switch localization {
            case .españolEspaña:
    ...
    private static func checkGrammarWithSpelling() -> MenuEntry<MenuBarLocalization> {
      let checkGrammarWithSpelling = MenuEntry(
        label: .static(
          UserFacing<StrictString, MenuBarLocalization>({ localization in
            switch localization {
            case .españolEspaña:
    ...
    private static func correctSpellingAutomatically() -> MenuEntry<MenuBarLocalization> {
      let correctSpellingAutomatically = MenuEntry(
        label: .static(
          UserFacing<StrictString, MenuBarLocalization>({ localization in
            switch localization {
            case .españolEspaña:
